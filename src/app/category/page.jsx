    ...
    <div className="wrapper">
      ...
      <div className={styles.category}>
        <div className={styles.filter}>
          <div className={styles.genderWise}>
            <div className={styles.block}>
              <input name="option1" id="men" type="radio" value="1" />
              <label htmlFor="men">Men</label>
            </div>
            <div className={styles.block}>
              <input name="option2" id="women" type="radio" value="2" />
              <label htmlFor="women">Women</label>
            </div>
            <div className={styles.block}>
              <input name="option3" id="boys" type="radio" value="3" />
              <label htmlFor="boys">Boys</label>
            </div>
            <div className={styles.girls}>
              <input name="option4" id="boys" type="radio" value="4" />
              <label htmlFor="boys">Girls</label>
            </div>
          </div>
        </div>
        <div className={styles.products}>
          {kidcloth.map((link, index) => {
            return <Card link={link} key={index}></Card>;
          })}
        </div>
      </div>
      <TabBar2></TabBar2>
